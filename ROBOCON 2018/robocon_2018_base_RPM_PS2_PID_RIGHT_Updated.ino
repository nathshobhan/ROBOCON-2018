    ...
    while((ps2.readButton(PS2_JOYSTICK_RIGHT_UP)>50)&&(ps2.readButton(PS2_JOYSTICK_RIGHT_LEFT)<50)&&(ps2.readButton(PS2_JOYSTICK_RIGHT_RIGHT)<50))  
        {
          ...
          if(!ps2.readButton(PS2_JOYSTICK_RIGHT))
            ...
            setpoint1 = setpoint2 = setpoint3 = setpoint4  = map(ps2.readButton(PS2_JOYSTICK_RIGHT_UP),0,100,0,100); //Speed
            }
          else
            {
              if(flagsw==true){
             ...
             setpoint1 = setpoint2 = setpoint3 =setpoint4  = map(ps2.readButton(PS2_JOYSTICK_RIGHT_UP),0,100,0,350); //Speed
            }
   ...
   {Serial.println("bkwd");
    while((ps2.readButton(PS2_JOYSTICK_RIGHT_DOWN)>50)&&(ps2.readButton(PS2_JOYSTICK_RIGHT_LEFT)<50)&&(ps2.readButton(PS2_JOYSTICK_RIGHT_RIGHT)<50))  
         ...
         if(!ps2.readButton(PS2_JOYSTICK_RIGHT))
         {
            ...
            setpoint1 = setpoint2 = setpoint3 = setpoint4  = map(ps2.readButton(PS2_JOYSTICK_RIGHT_DOWN),0,100,0,150); //Speed
         }
          else
            {
             if(flagsw==true){
    ...
    while((ps2.readButton(PS2_JOYSTICK_RIGHT_LEFT)>50)&&(ps2.readButton(PS2_JOYSTICK_RIGHT_UP)<50)&&(ps2.readButton(PS2_JOYSTICK_RIGHT_DOWN)<50))
        {
          ...
          if(!ps2.readButton(PS2_JOYSTICK_RIGHT))
          {
           ...
           setpoint1 = setpoint2 = setpoint3 = setpoint4  = map(ps2.readButton(PS2_JOYSTICK_RIGHT_LEFT),0,100,0,150); //Speed
          }
          else
          {
           if(flagsw==true){
    ...
    while((ps2.readButton(PS2_JOYSTICK_RIGHT_RIGHT)>50)&&(ps2.readButton(PS2_JOYSTICK_RIGHT_UP)<50)&&(ps2.readButton(PS2_JOYSTICK_RIGHT_DOWN)<50))
        {
          ...
          if(!ps2.readButton(PS2_JOYSTICK_RIGHT))
          {
            ...
            setpoint1 = setpoint2 = setpoint3 = setpoint4  = map(ps2.readButton(PS2_JOYSTICK_RIGHT_RIGHT),0,100,0,150); //Speed
          }
          else
          {
            if(flagsw==true){
...
else if(ps2.readButton(PS2_LEFT_1)==0)  // rotate left
    {
     while(ps2.readButton(PS2_LEFT_1)==0)
         { 
          ...
          setpoint1 = setpoint2 = setpoint3 = setpoint4 = 150;//Speed);
          }
          else
          {
           if(flagsw==true){
          ...
          setpoint1 = setpoint2 = setpoint3 = setpoint4 = 200;//Speed);
          }          
...
else if(ps2.readButton(PS2_RIGHT_1)==0)  // rotate right
    {
     while(ps2.readButton(PS2_RIGHT_1)==0)
         {         
          ...
          setpoint1 = setpoint2 = setpoint3 = setpoint4 = 100;//Speed);
          }
          else
          {
            if(flagsw==true){
